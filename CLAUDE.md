...
- **Known-true facts (keep consistent):** GPA **3.87**; **10** robots designed; **16** podium finishes across 5 events; **4th** national Plastic Antweight (2024 RCL). Machining is **outsourced** (not in-house). Dog is **Mocha**. No "hammer" weapons.
  - **Graduating May 2029**; started Sep 2025; **seeking a Summer 2027 co-op** (hardware / robotics). These appear in five places and must stay in sync: the hero telemetry "Seeking" cell, the About facts strip "Graduating" cell, the Education card date, the print brief's `.ps-when`, and the contact lead. Confirmed by the owner 2026-09.
